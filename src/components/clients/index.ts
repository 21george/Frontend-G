// Sidebar
export { ClientDetailSidebar } from './ClientDetailSidebar'
...
export { ClientNutritionTab } from './tabs/ClientNutritionTab'
export { ClientAnalyticsTab } from './tabs/ClientAnalyticsTab'
