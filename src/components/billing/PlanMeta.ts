...
export const PLANS: PlanDefinition[] = [
  {
    ...
    name: 'No Plan',
    periods: {
      monthly: { price: 0, priceLabel: '$0', periodLabel: '/mo', discountPct: 0 },
      quarterly: { price: 0, priceLabel: '$0', periodLabel: '/3 mo', discountPct: 0 },
      semi_annual: { price: 0, priceLabel: '$0', periodLabel: '/6 mo', discountPct: 0 },
      annual: { price: 0, priceLabel: '$0', periodLabel: '/yr', discountPct: 0 },
    },
    icon: Zap,
    accent: '#94a3b8',
    energy: false,
  ...
  },
  {
    ...
    name: 'Pro',
    periods: {
      monthly: { price: 29, priceLabel: '$29', periodLabel: '/mo', discountPct: 0 },
      quarterly: { price: 78, priceLabel: '$78', periodLabel: '/3 mo', discountPct: 10 },
      semi_annual: { price: 147, priceLabel: '$147', periodLabel: '/6 mo', discountPct: 15 },
      annual: { price: 278, priceLabel: '$278', periodLabel: '/yr', discountPct: 20 },
    },
    icon: Crown,
    accent: '#a3e635',
    energy: true,
  ...
  },
  {
    ...
    name: 'Business',
    periods: {
      monthly: { price: 79, priceLabel: '$79', periodLabel: '/mo', discountPct: 0 },
      quarterly: { price: 213, priceLabel: '$213', periodLabel: '/3 mo', discountPct: 10 },
      semi_annual: { price: 402, priceLabel: '$402', periodLabel: '/6 mo', discountPct: 15 },
      annual: { price: 758, priceLabel: '$758', periodLabel: '/yr', discountPct: 20 },
    },
    icon: Building2,
    accent: '#8B5CF6',
    energy: false,
...
export function getPlanPricing(tier: SubscriptionTier, period: SubscriptionPeriod): PeriodPricing {
