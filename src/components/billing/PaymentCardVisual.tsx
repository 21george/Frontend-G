...
export function PaymentCardVisual({
  ...
  if (isDefault) {
    return (
      <div
        className={`relative  p-5 ${style.bg} ${style.text} shadow-xl overflow-hidden ${className}`}
      >
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-6">
        <span
          className={`text-sm font-bold tracking-wider ${style.bg} ${style.text} px-2 py-0.5 rounded-md`}
        >
          {style.logo}
        </span>
      </div>
