      ...
      <DashboardLayout>
        <div className="mx-auto p-4 sm:p-6 lg:p-8">
          <div className="card p-6 sm:p-8 text-center">
            ...
            {emailError && (
              <div className="flex items-center justify-center gap-2 mb-4 px-4 py-2.5 bg-amber-50 border border-amber-200 text-amber-700 text-[13px] font-medium">
  ...
  return (
    <DashboardLayout>
      <div className="mx-auto p-4 sm:p-6 lg:p-8">
        <Link
          href="/clients"
          className="flex items-center gap-1 text-sm text-gray-100 hover:text-gray-900 mb-6"
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                {!errors.email && emailState === "invalid" && (
                  <p className="flex items-center gap-1 text-red-500 text-xs mt-1">
                    <AlertCircle size={11} /> Email domain has no valid MX
                    records
                  </p>
                )}
              </div>
