    ...
    return (
      <DashboardLayout>
        <div className="max-w-4xl space-y-4">
          ...
          <div className="space-y-3 p-6 border border-[var(--border)] rounded-xl bg-[var(--bg-card)]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                className="flex items-center gap-3 p-4 border border-[var(--border)] rounded-xl bg-[var(--bg-card)]"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div
                            className={`w-5 h-5 border-2 rounded-full flex items-center justify-center flex-shrink-0 transition-all ${
                              isSelected
          ...
          <div>
            ...
            >
              ...
              <div className="mb-4">
                <div className="text-3xl font-bold text-[var(--text-primary)] dark:text-[var(--text-primary)]">
                  {selectedClients.length}
                </div>
                <div className="text-xs text-[var(--text-secondary)] dark:text-[var(--text-secondary)]">
                  clients selected
                </div>
              </div>
