    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <nav className="flex items-center gap-2 text-xs text-slate-500 dark:text-neutral-400 mb-3 uppercase tracking-tighter">
              ...
              <ChevronRight className="w-3 h-3" />
              <Link href={`/workout-plans/${id}`} className="hover:text-cyan-950 dark:hover:text-[#b3d2ef] transition-colors truncate max-w-[150px]">
                {plan.title}
              </Link>
              <ChevronRight className="w-3 h-3" />
              <span className="text-cyan-950 dark:text-[#b3d2ef]">Assign</span>
            </nav>
        ...
        <motion.div
          ...
          className="bg-white dark:bg-[#171717] rounded-2xl border border-slate-200/80 dark:border-white/[0.08] p-5 shadow-sm"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-48 pl-9 pr-3 py-1.5 text-sm bg-slate-50 dark:bg-white/[0.04] border border-slate-200 dark:border-white/[0.08] rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-950/20 dark:focus:ring-cyan-400/20"
                    />
                  </div>
                </div>
              </div>
                  ...
                  return (
                    <motion.button
                      ...
                      className={`relative p-4 rounded-xl border text-left transition-all ${
                        isSelected
                          ? 'bg-cyan-950/5 dark:bg-cyan-950/20 border-cyan-500/50 shadow-md shadow-cyan-500/10'
          ...
          <div>
            <motion.div
              ...
              className="bg-white dark:bg-[#171717] rounded-2xl border border-slate-200/80 dark:border-white/[0.08] p-5 shadow-sm sticky top-6"
            >
                  ...
                  {selectedClients.map(clientId => {
                    ...
                    return (
                      <motion.div
                        ...
                        exit={{ opacity: 0, x: 10 }}
                        className="flex items-center justify-between gap-2 p-2 bg-slate-50 dark:bg-white/[0.04] rounded-lg"
                      >
                        <div className="flex items-center gap-2 min-w-0">
                          <div className="w-6 h-6 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white text-[10px] font-semibold flex-shrink-0">
                            {client.name?.[0]?.toUpperCase() ?? 'C'}
                          </div>
                        ...
                        <button
                          ...
                          className="p-1 hover:bg-slate-200 dark:hover:bg-white/[0.08] rounded transition-colors"
                        >
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="w-full py-2.5 bg-cyan-950 hover:bg-cyan-900 disabled:bg-slate-300 dark:disabled:bg-white/[0.1] text-white text-sm font-medium rounded-lg transition-colors flex items-center justify-center gap-2 disabled:cursor-not-allowed"
                >
                ...
                <Link
                  ...
                  className="block w-full py-2.5 text-center text-sm font-medium text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-white/[0.1] bg-white dark:bg-white/[0.04] rounded-lg hover:bg-slate-50 dark:hover:bg-white/[0.08] transition-colors"
                >
                  Cancel
                </Link>
              </div>
