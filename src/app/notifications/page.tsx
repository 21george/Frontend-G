...
import { useNotifications, useMarkNotificationRead, useMarkAllNotificationsRead, useUnreadNotificationCount } from '@/hooks/useNotifications'
...
const notificationColors: Record<string, string> = {
  ...
  checkin_scheduled: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-400',
}
    ...
    <div className="max-w-4xl mx-auto p-4 sm:p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <Link href="/dashboard" className="p-2 hover:bg-slate-100 dark:hover:bg-white/10 rounded-lg">
        ...
        <div className="flex items-center gap-2">
          {/* Filter toggle */}
          <div className="flex rounded-lg border border-slate-200 dark:border-white/20 overflow-hidden">
            <button
      ...
      <div className="space-y-2">
        {isLoading ? (
          <div className="text-center py-12">
            <div className="inline-block animate-spin rounded-full h-8 w-8 border-4 border-slate-200 dark:border-white/20 border-t-slate-900 dark:border-white" />
