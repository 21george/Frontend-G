  ...
  return (
    ...
    >
      <svg
        ...
        style={{ opacity: 0.55 }}
      >
        {/* Terminal block — uses CSS vars so it adapts to both themes */}
        <rect
          x={bx}
          y={by}
          width="84"
    ...
    <>
      ...
      <div className="relative min-h-screen flex items-center justify-center bg-[#F8FAFC] dark:bg-[#0e0e0e] overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 60% 50% at 50% 50%, rgba(30,30,30,0.45) 0%, transparent 70%)",
          }}
          aria-hidden
        />

        {/* Light mode subtle decorative gradient */}
        <div
          className="dark:hidden absolute inset-0 pointer-events-none"
          style={{
            background:
              "radial-gradient(ellipse 70% 60% at 50% 50%, rgba(19,46,53,0.06) 0%, transparent 70%)",
          }}
          aria-hidden
        />
          ...
          <div className="flex items-center justify-center gap-3 mb-1">
            <div className="flex gap-[3px]" aria-hidden>
              {[...Array(5)].map((_, i) => (
                <div
                  key={i}
                  className="w-[3px] h-[3px] rounded-full bg-[#CBD5E1] dark:bg-[#383838]"
                />
              ))}
            </div>
          ...
          >
            ...
            <div>
              ...
              {form.formState.errors.email && (
                <p className="text-red-400 text-[11px] mt-1 pl-1">
