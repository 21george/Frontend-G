...
const CATEGORY_CONFIG: Record<string, { icon: typeof Flame; gradient: string; glow: string }> = {
 strength: { icon: Dumbbell, gradient: 'from-orange-500 to-red-500', glow: 'shadow-lg shadow-orange-500/20' },
 cardio: { icon: Heart, gradient: 'from-rose-500 to-pink-500', glow: 'shadow-lg shadow-rose-500/20' },
 hiit: { icon: Zap, gradient: 'from-amber-500 to-orange-500', glow: 'shadow-lg shadow-amber-500/20' },
 yoga: { icon: Sparkles, gradient: 'from-violet-500 to-purple-500', glow: 'shadow-lg shadow-violet-500/20' },
 pilates: { icon: TrendingUp, gradient: 'from-teal-500 to-emerald-500', glow: 'shadow-lg shadow-emerald-500/20' },
 stretching: { icon: Heart, gradient: 'from-sky-500 to-blue-500', glow: 'shadow-lg shadow-sky-500/20' },
 functional: { icon: Flame, gradient: 'from-lime-500 to-green-500', glow: 'shadow-lg shadow-lime-500/20' },
 other: { icon: Radio, gradient: 'from-slate-500 to-slate-600', glow: 'shadow-lg shadow-slate-500/20' },
}
...
export default function LiveTrainingPage() {
 ...
 {[
 { icon: Signal, value: stats.live, label: 'Live Now', gradient: 'from-green-500 to-green-600', accent: 'from-green-500/10', hover: 'hover:border-green-500/30 hover:shadow-green-500/5', glow: 'shadow-lg shadow-green-500/20', pulse: true },
 { icon: Clock, value: stats.upcoming, label: 'Upcoming', gradient: 'from-amber-500 to-amber-600', accent: 'from-amber-500/10', hover: 'hover:border-amber-500/30 hover:shadow-amber-500/5', glow: 'shadow-lg shadow-amber-500/20', pulse: false },
 { icon: CheckCircle2, value: stats.ended, label: 'Completed', gradient: 'from-sky-500 to-sky-600', accent: 'from-sky-500/10', hover: 'hover:border-sky-500/30 hover:shadow-sky-500/5', glow: 'shadow-lg shadow-sky-500/20', pulse: false },
 ...
 <span className={`inline-flex px-2 py-0.5 text-[10px] font-semibold capitalize border ${levelConf}`}>
 {session.level}
 </span>
 </div>
 ...
 className="inline-flex items-center gap-1 px-3 py-1.5 bg-cyan-950 cursor-pointer text-white text-[11px] font-semibold shadow-cyan-500/20 hover:shadow-md hover:shadow-cyan-500/30 transition-all"
 >
 <Play size={11} />
 Live
 </button>
 ...
 className="inline-flex items-center gap-1 px-3 py-1.5 bg-gradient-to-r from-red-500 to-rose-600 text-white text-[11px] font-semibold hover:shadow-md hover:shadow-red-500/30 transition-all"
 >
 End
 </button>
 )}
