...
export const clientsApi = {
  ...
  get: (id: string) =>
    api
      .get<ApiResponse<Client>>(`/coach/clients/${id}`)
      .then((r) => r.data.data),
  ...
  regenerateCode: (id: string) =>
    api
      .post<
        ApiResponse<{ login_code: string }>
      >(`/coach/clients/${id}/regenerate-code`)
      .then((r) => r.data),

  block: (id: string) =>
    api
      .post<ApiResponse<Client>>(`/coach/clients/${id}/block`)
      .then((r) => r.data.data),

  unblock: (id: string) =>
    api
      .post<ApiResponse<Client>>(`/coach/clients/${id}/unblock`)
      .then((r) => r.data.data),
    ...
    if (params.email) {
      checks.push(
        api
          .get<
            PaginatedResponse<Client>
          >("/coach/clients", { params: { search: params.email } })
          .then((r) => {
    ...
    if (params.phone) {
      checks.push(
        api
          .get<
            PaginatedResponse<Client>
          >("/coach/clients", { params: { search: params.phone } })
          .then((r) => {
