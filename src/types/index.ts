...
export interface Invoice {
  id: string;
  number: string; // e.g. "INV-0001" or Stripe number
  status: "paid" | "open" | "void" | "uncollectible";
  date: string; // Unix timestamp (seconds) from Stripe
  amount: number; // in dollars (backend divides amount_paid / 100)
  currency?: string;
  pdf_url?: string;
